...
# Help: guide
help_msg = "Написать оператору t.me/apteekplus"
...
error_packagesize_does_not_exist = "⚠️  The selected packagesize does not exist."
error_product_does_not_exist = "⚠️  The selected product does not exist."
error_product_not_available = "⚠️  The selected product is not available."
error_product_not_in_stock = "⚠️  The selected product is not in stock."
error_product_out_of_stock = "⚠️  The selected product is out of stock."
error_product_not_enough_in_stock = "⚠️  There is not enough of the selected product in stock."
error_product_not_enough_available = "⚠️  There is not enough of the selected product available."
error_product_not_enough_in_stock_available = "⚠️  There is not enough of the selected product in stock or available."
error_product_not_enough_in_stock_available_user = "⚠️  There is not enough of the selected product in stock or available for you."
error_product_not_enough_in_stock_user = "⚠️  There is not enough of the selected product in stock for you."
error_product_not_enough_available_user = "⚠️  There is not enough of the selected product available for you."
error_cannot_order_own_product = "⚠️  You cannot order your own product."
error_unknown_payment_provider = "⚠️  Unknown payment provider."
error_payment_provider_not_configured = "⚠️  The payment provider is not configured."
error_payment_failed = "⚠️  The payment failed."
error_payment_not_completed = "⚠️  The payment was not completed."
error_payment_already_completed = "⚠️  The payment was already completed."
error_payment_not_found = "⚠️  The payment was not found."
error_payment_cancelled = "⚠️  The payment was cancelled."
error_payment_refunded = "⚠️  The payment was refunded."
