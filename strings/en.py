...
conversation_after_start = "Hello!\n" \
                           ...
                           "If you find any, please report them to t.me/APTEEKPLUS ."
...
# Order product: notes?
ask_order_notes = "Specify the neighbourhood you need the drop in(Musta/Lasna...) \n" \
                  "💼 It will ONLY be seen by store operator.\n"
...
# Help: guide
help_msg = "For help, write the operator:\n" \
           "t.me/APTEEKPLUS"
...
error_product_out_of_stock = "⚠️  We are currently out of stock."
error_no_products = "⚠️  There are no products currently in stock"
error_size_does_not_exist = "⚠️  The selected size does not exist."
error_no_sizes = "⚠️  There are no sizes available for this product."
error_no_categories = "⚠️  There are no categories available."
error_no_regions = "⚠️  There are no regions available."
error_no_packagesizes = "⚠️  There are no packagesizes available."
error_no_products_in_category = "⚠️  There are no products in this category."
error_no_products_in_region = "⚠️  There are no products in this region."
error_no_products_in_packagesize = "⚠️  There are no products in this packagesize."
